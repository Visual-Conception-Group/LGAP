...
class parser():
    def __init__(self):
        ...
        # self.outdir = "../BLIP/experiment_1/imagenet/adv_test_generated_50K_1_iter_10_step" #dir to write results to
        self.skip_grid = True
        ...
        self.strength = 0.1 #strength for noising/unnoising. 1.0 corresponds to full destruction of information in init image
        self.from_file = ""
...
inverse_resize = transforms.Compose([transforms.Resize((256,256))])
batch_size = opt.n_samples
# num_classes = 10
image_folder = '../BLIP/experiment_1/imagenet/adv_test_standard_aa_Linf_eps_4_wrn50_2'
label_file = '../BLIP/experiment_1/imagenet/clean_test_labels_50K.txt'
...
for sample in test_loader:
    ...
    for a_i in generated_image:
        ...
        save_image(a_i, "../BLIP/experiment_1/imagenet/adv_test_generated_standard_aa_Linf_eps_4_wrn50_2/{}.png".format(count))
