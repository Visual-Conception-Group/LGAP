...
blip_inv_normalize = transforms.Compose([ transforms.Normalize(mean = [ 0., 0., 0. ],
                            ...
                            #    ])
inverse_resize = transforms.Compose([transforms.Resize((224,224))])
...
# classifier = torch.load("wrn28_10_cifar10_trained_on_diffusion_images_only.pth")
...
for x, y  in tqdm(test_loader):
    x_adv, _, _ = bpda_strong(x.to(torch.float16),y,defense,classifier.to(torch.float16), n_eot=1, ptb=4)
